...
public class PlaceProvider extends ContentProvider{
    ...
    public static final String AUTHORITY = "com.example.diba.applicationparentchild.PlaceProvider";
    ...
    String mKey = "key=AIzaSyBqU7APx6tTBf-sjOvSsKAPjmqc5uGY6s8";   //Browser Key
